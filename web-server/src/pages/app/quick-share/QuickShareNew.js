        ...
        <div className="d-flex flex-row gap-3">
            ...
            <div className="d-flex flex-column flex-wrap gap-3 justify-content-center mt-2">
                <div style={{ maxWidth: "400px" }}>
                    ...
                    <UploadFilesArea allowFolders={true} onFilesChange={onFilesChange} className="bg-body rounded-4 active:tw-outline tw-outline-1 tw-outline-border"  style={{ minWidth: "300px" }} />
